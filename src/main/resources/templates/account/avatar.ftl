				...
				<ul class="nav navbar-nav navbar-right sign">
					...
					<li class="dropdown">
						<a href="#" class="ava dropdown-toggle" data-toggle="dropdown">
							<img class="img-circle" src="/store/avatar/2019/04/03/3f45c745-e8a5-4fdc-bd67-774ff9403aa1.jpg">
						</a>
						...
						<div class="panel-body">
							...
							<form id="f_ava" class="form-horizontal" action="avatar" method="post">
								...
								<div class="update_ava">
									<img src="/store/avatar/2019/04/03/3f45c745-e8a5-4fdc-bd67-774ff9403aa1.jpg" id="target" alt="[Jcrop Example]" />
								</div>
